...
export class ShipCanvas extends React.Component {
  ...
  componentDidMount() {
    this.drawShip(this.props.shipModel, this.props.shipLoadout, [1, 0, 0, 0, 1, 0, 0, 0, 1]);
  ...
  async drawShip(shipModel, shipLoadout, transform) {
    ...
    adjustedGunPositions = spreadGunPositions(adjustedGunPositions, iconSize, 10, [localMin[0], localMax[0]], [localMin[1], localMax[1]]);
    // Draw gun icons.
