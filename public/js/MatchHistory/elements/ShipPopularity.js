class ShipPopularityList extends HTMLUListElement {
  constructor() {
    super();
    this.classList.add('ship-popularity-list');
  }

  initialize(modelWinrates, totalMatches) {
...
customElements.define('ship-popularity-list', ShipPopularityList, { extends: 'ul' });
