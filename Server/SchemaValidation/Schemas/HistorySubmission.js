...
const PLAYER_DATA_SCHEMA = Joi.object({
    UserId: Joi.number()
        .integer()
        .required(),
    Name: Joi.string()
...
const SHIP_DATA_SCHEMA = Joi.object({
    ...
    SlotNames: Joi.array()
        ...
        .max(6)
        .required(),
    Players: Joi.array().items(PLAYER_DATA_SCHEMA, null)
});

const LOBBY_DATA_SCHEMA = Joi.object({
    ...
    Scores: Joi.array()
        ...
        .max(8)
        .required(),
    Ships: Joi.array().items(SHIP_DATA_SCHEMA).max(8),
});
